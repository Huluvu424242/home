...
H. R. Kunze in einem Nebensatz ein dichtendes Kind besingt: "Seine Texte handeln vom Schreiben, von etwas anderem handeln sie nicht." Natürlich hat
er Recht und so versuche ich es nun mit Kurzgeschichten. Vielleicht bekomme ich sie ja dann mal irgendwann zusammen verbunden zu einer großen Geschichte.
