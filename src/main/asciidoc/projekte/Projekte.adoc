...
* *2002 (1 Monat)* Erstellung Programmierrichtlinien für Oracle
[horizontal]
Betriebssystem:: 	Windows 2000
Sprache:: 	PL/SQL, SQL
Datenbank:: 	Oracle
Werkzeuge:: 	Office
Technologien:: 	Datenbankprogrammierung
...
Sprache:: 	Java, SQL, PL/SQL
Datenbank:: 	Oracle
Werkzeuge:: 	Kawa IDE,Visual-Age,Eclipse,CVS,Bea-Weblogic, JBoss, Ant, PowerDesigner, Benthic-Tools
...
* *2012 (3 Monate)* link:https://github.com/Huluvu424242/rezept-xml[Erstellung XML/XSLT Templates für Rezepte]
[horizontal]
